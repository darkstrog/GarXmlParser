...
namespace GarXmlParserConsole
{
    internal class Program
    {
        ...
        static async Task Main(string[] args)
        {
            ...
            string connectionString = "Host=localhost;Port=5432;Database=GARBase;Username=postgres;Password=postgres";
            ...
            List<int> regions = new List<int> { 50, 77, 90, 99 };
            ...
            //_ = await parseAndPushToBase.AddressObjectDivisionDataProcess(garProcessor,
            //                                                    loggerFactory,
            //                                                    connectionString,
            //                                                    token,
            //                                                    zipPath, regions);
            //_ = await parseAndPushToBase.AddressObjectDataProcess(garProcessor,
            //                                                    loggerFactory,
            //                                                    connectionString,
            //                                                    token,
            //                                                    zipPath, regions);
            _ = await parseAndPushToBase.AdmHierarchyDataProcess(garProcessor,
                                                                loggerFactory,
                                                                connectionString,
                                                                token,
                                                                zipPath, regions);
