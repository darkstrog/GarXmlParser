namespace GarXmlParser.GarEntities
{
    ...
    //------------------------------------------------------------------------------
    //     Внесеные изменения:
    //     Исходное имя класса-коллекции созданное генератором изменено на: Apartments
    //     Имя класса элемента коллекции изменено на: Apartment
    // 
    //------------------------------------------------------------------------------
    ...
    public partial class Apartments
    {
        ...
        private Apartment[] aPARTMENTSField;
