...
{
    public class HousesParamsService: IHousesParamsService
    {
        private readonly ILogger<HousesParamsService> _logger;
        private readonly IHousesParamsRepo _repository;
        private readonly IProblemDataService<ParamDto> _problemDataService;

        public HousesParamsService(IHousesParamsRepo repository, IProblemDataService<ParamDto> problemDataService, ILogger<HousesParamsService> logger)
        {
            _logger = logger;
