...
{
    public class CarPlaceParamsService: ICarPlaceParamsService
    {
        private readonly ILogger<CarPlaceParamsService> _logger;
        private readonly ICarPlaceParamsRepo _repository;
        private readonly IProblemDataService<ParamDto> _problemDataService;

        public CarPlaceParamsService(ICarPlaceParamsRepo repository, IProblemDataService<ParamDto> problemDataService, ILogger<CarPlaceParamsService> logger)
        {
            _logger = logger;
